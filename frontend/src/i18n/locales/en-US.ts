...
\
  ...
  datasource: {
    ...
    noResourcesDesc_confluence: 'Make sure the account can read spaces and the Confluence Base URL is reachable from the server',
    ...
    connectorDesc: {
      ...
      confluence: 'Sync spaces and pages from internal Confluence',
    },
    field: {
      appId: 'App ID',
